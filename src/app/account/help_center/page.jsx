  ...
  return (
    <section className='flex flex-col gap-4 max-md:gap-2'>
      <div className="w-full bg-white rounded-xl h-fit py-2 px-4">
        <p className="font-bold text-xl text-dark">Help Center</p>
      </div>
      <div className=" w-full bg-white h-auto rounded-xl p-4 max-md:p-2">
        <h1 className="font-bold text-dark text-center text-2xl max-md:text-xl">How can we help you?</h1>
