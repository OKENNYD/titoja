  ...
  return (
    <section className='flex flex-col gap-4 max-md:gap-2'>
      <div className="w-full bg-white rounded-xl h-fit py-2 px-4">
        <p className="font-bold text-xl text-dark">FeedBacks</p>
      </div>
      <div className=" w-full bg-white h-auto rounded-lg px-4 py-4">
        <nav className="">
          <ul className=" flex gap-4 text-dim font-bold text-base">
            <li className="text-secondary">Awaiting</li>
            <li>Replied</li>
            <li>By you</li>
          </ul>
        </nav>
        <form className='w-2/5 max-md:w-full flex overflow-hidden rounded-full my-2'><input className="w-full h-8 px-3 caret-secondary bg-dim rounded-l-full outline-primary" type="text" name="order_tracking_id" placeholder="Order ID, Product or Store Name " /><button className='bg-primary text-white font-semibold text-base px-3' type="submit"> <IoSearch /> </button> </form>
        <table className="w-full">
          <thead className="w-full border-solid border-2 border-collapse">
            <tr className="w-full border-solid border-2 border-collapse bg-dim text-dim rounded-full">
