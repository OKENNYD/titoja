            ...
            <form>
              <div className="w-auto h-auto box-border text-lg font-semibold">
                ...
                <div className="gap-2 flex h-8 flex-row ">
                  ...
                  <label
                    htmlFor="img3"
                    className="h-8 w-8 overflow-hidden border-2 rounded-xl peer-checked/blue:border-primary"
                  >
                    <Image
                  ...
                  <label
                    htmlFor="img4"
                    className="h-8 w-8 overflow-hidden border-2 rounded-xl peer-checked/red:border-primary"
                  >
                    <Image
                      src={Images.dimension}
                      alt="product img"
            ...
            <div className=" w-auto h-auto box-border text-lg font-semibold">
              ...
              <div className=" w-auto h-auto box-border text-lg font-semibold">
                ...
                <div className=" p-1 w-24 h-8 gap-2 flex text-slate-600 items-center text-1xl outline-0 border-0 bg-dim rounded-full cursor-pointer ">
                  ...
                  <p className=" w-full border-0 outline-0 text-center bg-transparent">
                    {stockCount}
                  </p>
                  <button
