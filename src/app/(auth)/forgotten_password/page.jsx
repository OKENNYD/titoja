    ...
    return (
      <main className="max-md:p-6 w-full pb-48 pt-20 h-full flex items-center justify-center">
        <div className="w-[30%] max-md:w-4/5 bg-white rounded-2xl h-auto py-6 px-6">
          <h3 className="text-dim text-xl font-bold text-center">
            Verify Email
          </h3>
          ...
          >
            <input
              ...
              id="email"
              placeholder="email"
              className=" p-2 ps-4 border-primary outline-primary w-full h-10 caret-secondary text-base placeholder:text-gray-400 bg-gray-100 rounded-2xl text-black"
            />
            <button
              type="submit"
