...
import Download from "@/components/Nav/Download";
...
export default function Layout({ children }) {
  return (
    <div className=" bg-gray-200 dark:bg-dim  bar">
      <AuthHeader />
      {children}
      <footer className="max-md:p-2 bg-white dark:bg-dark w-full h-auto flex justify-center items-center">
        <div className="w-full max-md:flex-col-reverse gap-4 max-md:gap-2 max-md:justify-start h-auto font-normal text-lg flex justify-center items-center m-2 py-2 px-16 max-md:px-4 ">
          <ol className=" inline-flex text-sm list-none flex-wrap text-dim dark:text-gray-400 ">
