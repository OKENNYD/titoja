   ...
   return (
     <main className="max-md:p-6 w-full pb-48 pt-20 h-full flex items-center justify-center">
       <div className="w-[30%] max-md:w-4/5 bg-white dark:bg-dark rounded-2xl h-auto py-6 px-6">
         <h3 className="dark:text-gray-400 text-dim  text-xl font-bold text-center"></h3>
         ...
         <form method="post" className=" max-md:px-2 flex flex-col gap-4 mt-2 ">
           <input
             ...
             id="email"
             placeholder="email"
             className=" p-2 ps-4 border-primary outline-primary w-full h-10 font-medium caret-secondary text-base placeholder:text-slate-400 bg-gray-200 dark:bg-gray-400 rounded-2xl text-black "
           />
           <button
             type="submit"
