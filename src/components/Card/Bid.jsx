...
export default function Bid({status,name,price}) {
  ...
  return (
    <Link
      ...
      className="shrink-0 md:w-1/4 max-md:w-1/2 h-auto flex gap-2 bg-white hover:shadow hover:shadow-gray-200 rounded-2xl relative p-2 box-border"
    >
      <Image
        src={Images.img_3}
        alt="product img"
      ...
      <div className="flex flex-col text-dim gap-1">
        ...
        <div className="flex gap-4 items-center">
          {status ? (
            <span className="bg-[#FF0000] w-fit h-auto px-2 text-sm text-white max-sm:text-xs rounded-2xl animate-pulse">
              Live
            </span>
          ) : (
