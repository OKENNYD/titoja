      ...
      >
        <g>
          <g>
            ...
            <path
              className="fill-white"
              d="m21.1,14.59c0-.55-.43-1-.96-1h-4.04v-4.04c0-.53-.45-.96-1-.96s-1,.43-1,.96v4.04h-4.04c-.53,0-.96.45-.96,1s.43,1,.96,1h4.04v4.04c0,.53.45.96,1,.96s1-.43,1-.96v-4.04h4.04c.53,0,.96-.45.96-1Z"
            />
          </g>
        </g>
      </svg>
